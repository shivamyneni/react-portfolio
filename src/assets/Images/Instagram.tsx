...
const Instagram = forwardRef<HTMLAnchorElement, InstagramProps>(
	({ color, ...props }, ref) => {
		return (
			<a
				ref={ref}
				className="p-[6px] rounded-xl bg-primary bg-opacity-80 backdrop-blur-md border-[3px] border-white hover:border-primary hover:bg-white transition-colors group duration-800"
