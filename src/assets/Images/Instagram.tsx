...
const Instagram = memo((props: CSSProperties) => {
  const { color } = props;
  return (
    <a
   className="p-[6px] rounded-xl  bg-primary  bg-opacity-80 backdrop-blur-md border-[3px]  border-primary hover:bg-white transition-colors group"
